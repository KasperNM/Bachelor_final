...
hrmodel4_fact <- lmerTest::lmer(value ~ fictfact + drift + (1|Participant_number), data = pivotfact)


hrmodel5_fict <- lmerTest::lmer(value ~ 1 + fictfact + drift + (1|Participant_number), data = pivotfict)
str(pivotfict)
...
hrmodel6 <- lmerTest::lmer(value ~ group*fictfact + drift + (1|Participant_number), data = pivotfictfactdf)
summary(hrmodel6)
